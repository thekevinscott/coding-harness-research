...
============================== 3 passed in 0.07s ================================`,h=`[main 4f9a2c1] Reject signup requests with an empty email
 1 file changed, 3 insertions(+)`,g={"app.py":l,"test_app.py":p};function T(){return g}e.s(["SIGNUP_APP_AFTER",0,u,"SIGNUP_APP_BEFORE",0,l,"SIGNUP_APP_WITH_FORMAT_CHECK",0,c,"SIGNUP_GIT_COMMIT_OUTPUT",0,h,"SIGNUP_PYTEST_FAILING",0,m,"SIGNUP_PYTEST_PASSING",0,f,"SIGNUP_PYTEST_PASSING_3",0,_,"SIGNUP_TEST_BEFORE",0,p,"SIGNUP_TEST_WITH_EMPTY_EMAIL_CASE",0,d,"signupProjectFiles",0,T,"writeSignupProjectFile",0,function(e,t){g={...g,[e]:t}}],30948);let y=new Set(["node_modules",".git",".next","dist","build","__pycache__",".turbo",".cache","coverage",".pytest_cache",".mypy_cache","target","vendor",".DS_Store"]),w={ts:"typescript",tsx:"typescript",js:"javascript",jsx:"javascript",mjs:"javascript",cjs:"javascript",py:"python",rb:"ruby",go:"go",rs:"rust",java:"java",kt:"kotlin",swift:"swift",c:"c",cpp:"cpp",h:"c",hpp:"cpp",cs:"csharp",html:"html",htm:"html",css:"css",scss:"css",less:"css",json:"json",jsonl:"json",yaml:"yaml",yml:"yaml",toml:"toml",xml:"xml",md:"markdown",mdx:"markdown",sh:"bash",bash:"bash",zsh:"bash",fish:"bash",sql:"sql",graphql:"graphql",gql:"graphql",dockerfile:"dockerfile",tf:"hcl",hcl:"hcl",env:"bash",gitignore:"bash",txt:"text",pdf:"pdf",docx:"word"};function k(e){return new TextEncoder().encode(e).length}let v=null;function P(){return v??=(0,o.getRealFetch)()((0,s.demoAssetPath)("/demo-files/manifest.json")).then(e=>{if(!e.ok)throw Error(`HTTP ${e.status}`);return e.json()}).then(e=>e.files).catch(e=>{throw v=null,e})}let S=new Map(Object.entries(a).map(([e,t])=>[e,{path:e,size:k(t),content:t}])),E=new Map,R=null;async function j(e){return await b[0].load(),E.get(e)??null}let b=[{root:n.PROJECT_ROOT,async load(){let e=await P();await (R??=(async()=>{for(let{path:t,edits:s}of r){let n=e.find(e=>e.path===t);if(!n)continue;let o=await C(n).catch(()=>null);if(null===o)continue;let r=o;for(let e of s)r.includes(e.oldText)&&(r=r.replace(e.oldText,e.newText));r!==o&&(E.set(t,o),S.has(t)||S.set(t,{path:t,size:k(r),content:r}))}})().catch(()=>{R=null}));let t=new Map(e.map(e=>[e.path,e]));for(let[e,s]of S)t.set(e,s);return[...t.values()]}},{root:n.WORKTREE_ROOT,load:async()=>P()},{root:n.SCRATCH_ROOT,load:async()=>Object.entries(i).map(([e,t])=>({path:e,size:k(t),content:t}))},{root:n.SIGNUP_ROOT,load:async()=>Object.entries(T()).map(([e,t])=>({path:e,size:k(t),content:t}))}],O=b.map(e=>e.root);async function x(e){let t=b.find(t=>t.root===e);return t?t.load():[]}async function M(e){let t=function(e){for(let t of b){if(e===t.root)return{project:t,relative:""};if(e.startsWith(`${t.root}/`))return{project:t,relative:e.slice(t.root.length+1)}}return null}(e.replace(/\/+$/,"")||"/");if(!t)return null;if(""===t.relative)return{kind:"dir",relative:"",root:t.project.root};let s=await t.project.load(),n=s.find(e=>e.path===t.relative);if(n)return{kind:"file",file:n,relative:t.relative,root:t.project.root};let o=`${t.relative}/`;return s.some(e=>e.path.startsWith(o))?{kind:"dir",relative:t.relative,root:t.project.root}:null}async function A(e){let t=await M(e);if(!t||"dir"!==t.kind)return null;let s=await x(t.root),n=t.relative?`${t.relative}/`:"",o=new Map;for(let e of s){if(!e.path.startsWith(n))continue;let[t,...s]=e.path.slice(n.length).split("/");!t||y.has(t)||t.endsWith(".pyc")||o.set(t,(o.get(t)??!1)||s.length>0)}return[...o.entries()].map(([e,t])=>({name:e,isDir:t,size:0,modified:""})).sort((e,t)=>e.isDir!==t.isDir?e.isDir?-1:1:e.name.localeCompare(t.name))}let I=new Map;async function C(e){if(void 0!==e.content)return e.content;let t=e.asset,s=I.get(t);return s||((s=(0,o.getRealFetch)()($(e)).then(e=>{if(!e.ok)throw Error(`HTTP ${e.status}`);return e.text()})).catch(()=>I.delete(t)),I.set(t,s)),s}async function F(e){let t=await M(e);return t?.kind==="file"?C(t.file):null}function $(e){return e.asset?(0,s.demoAssetPath)(`/demo-files/f/${e.asset}`):null}function q(e){return(0,t.getImageMime)(e)||(0,t.getAudioMime)(e)||(0,t.getVideoMime)(e)||(0,t.getDocumentMime)(e)||"text/plain"}function D(e){return"text/plain"!==q(e)}let W=new Map;e.s(["PROJECT_ROOTS",0,O,"assetUrl",0,$,"fileMeta",0,function(e,s){let n;return{size:s.size,language:"dockerfile"===(n=(e.split("/").pop()??"").toLowerCase())||n.startsWith("dockerfile.")?"dockerfile":".env"===n||n.startsWith(".env.")?"bash":"makefile"===n||"gnumakefile"===n?"makefile":w[n.split(".").pop()??""]??"text",mime:q(e),previewKind:(0,t.documentPreviewKind)(e)}},"isBinaryPath",0,D,"listDirectory",0,A,"lookup",0,M,"originalText",0,j,"primeAssetLookup",0,function(){return P().then(e=>{for(let t of e)t.asset&&(W.set(`${n.PROJECT_ROOT}/${t.path}`,t.asset),W.set(`${n.WORKTREE_ROOT}/${t.path}`,t.asset))}).catch(()=>{})},"projectFiles",0,x,"readFileText",0,C,"readProjectText",0,F,"staticFileUrlForApi",0,function(e){let t=new URL(e,"http://demo.invalid"),o=t.searchParams.get("type");if("read"!==o&&"download"!==o)return e;let r="/"+t.pathname.replace(/^\/api\/files\//,"").split("/").map(decodeURIComponent).join("/");if("read"===o&&!D(r))return e;let a=function(e){let t=(0,n.relativeToProject)(e,n.PROJECT_ROOT);if(t)return S.get(t)?.content;let s=(0,n.relativeToProject)(e,n.SCRATCH_ROOT);if(s&&Object.hasOwn(i,s))return i[s]}(r);if(void 0!==a)return"download"===o?`data:text/plain;charset=utf-8,${encodeURIComponent(a)}`:e;let l=W.get(r);return l?(0,s.demoAssetPath)(`/demo-files/f/${l}`):e},"textChunk",0,function(e,s){let n=new TextEncoder().encode(e),o=Math.min(n.length,s+t.TEXT_PREVIEW_MAX_BYTES);for(;o<n.length&&o>s&&(192&n[o])==128;)o--;return{content:new TextDecoder().decode(n.slice(s,o)),nextOffset:o,truncated:o<n.length,language:"",size:n.length}}],14987)},56413,e=>{e.v(e=>Promise.resolve().then(()=>e(14987)))},47173,e=>{"use strict";let t="/Users/demo",s=`${t}/.pi/agent`,n=`${t}/code/pi-web`,o=`${t}/pi-cwd-20260918`,r=`${t}/code/signup-app`,a=`${t}/code/pi-web-worktrees/feat-session-timer`;e.s(["AGENT_DIR",0,s,"HOME",0,t,"PROJECT_BRANCH",0,"main","PROJECT_ROOT",0,n,"SCRATCH_ROOT",0,o,"SIGNUP_ROOT",0,r,"WORKTREE_BRANCH",0,"feat/session-timer","WORKTREE_ROOT",0,a,"relativeToProject",0,function(e,t=n){return e===t?"":e.startsWith(`${t}/`)?e.slice(t.length+1):null},"sessionFilePath",0,function(e,t,n){return`${s}/sessions/--${e.replace(/^[/\\]/,"").replace(/[/\\:]/g,"-")}--/${t.replace(/[:.]/g,"-")}_${n}.jsonl`}])},93981,e=>{"use strict";let t=(...e)=>fetch(...e);e.s(["getRealFetch",0,function(){return t},"setRealFetch",0,function(e){t=e}])},77471,e=>{e.v(e=>Promise.resolve().then(()=>e(93981)))},95802,e=>{e.v(t=>Promise.all(["static/chunks/10gap-_pl7s60.js","static/chunks/3xxgjlcswdmfe.js","static/chunks/0mckd3k4p5s8v.js","static/chunks/3-b1fguy2cvng.js","static/chunks/3v4bkmhoje89a.js","static/chunks/3m24uvcgw9m7m.js","static/chunks/0yk8z9afhcsyn.js","static/chunks/2v4b5-hkcu72_.js","static/chunks/2o79l4skyi35s.js","static/chunks/0qvow_9o41cgz.js","static/chunks/3egjwkejitey2.js"].map(t=>e.l(t))).then(()=>t(76913)))}]);