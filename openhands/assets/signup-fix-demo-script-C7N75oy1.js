...
def test_signup_rejects_whitespace_email(client):
    ...
    assert response.status_code == 400
`,error:null})}}function M(){let{action:e,toolCallId:t}=C(`git-commit`,`git add app.py && git commit -m "Reject empty email on signup"`);return{action:e,observation:w(e.id,t,e.action.command,`[main 8c1f0e2] Reject empty email on signup
 1 file changed, 3 insertions(+), 1 deletion(-)`,0)}}export{j as a,A as c,b as d,k as f,v as h,m as i,D as l,T as m,n,y as o,O as p,r,M as s,t,E as u};