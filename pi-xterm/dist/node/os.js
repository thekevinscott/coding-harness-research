const m = globalThis.__nodeBuiltins["os"];
export default m.default ?? m;
export const EOL = m.EOL;
export const arch = m.arch;
export const availableParallelism = m.availableParallelism;
